...
const SignUp = () => {
    ...
    async function submitting(value) {
        try {
            ...
            const response = await axios.post(
                "https://estethmarat-estethmarat794-gmailcom-estethmarats-projects.vercel.app/api/v1/charityOrganizations/add", // 🔹 ضع رابط الـ API الصحيح هنا
                formData,
                {
                    headers: {
    ...
    return (
        <div className={vazir.className}>
            ...
            <div className="my-20"><GuestRoute>
